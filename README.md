...
<b>Tritika: </b> Column-wise handling of missing values;Region-wise analysis;Literature review;Report Writing<br/>
<b>[Vishal-rao](https://github.com/vishal-rao/GTD-EDA): </b> Research;Data Collection;Row-wise handling of missing values using athrough a user-defined function;Year-wise analysis<br/>
<b>[VSManasi](https://github.com/VSManasi/Global-Terrorism-Database-EDA-project): </b> Statistically dealing with missing values;Attack-wise analysis;Presentation<br/>
